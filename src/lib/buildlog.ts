...
export const BUILD_LOG: BuildLogEntry[] = [
  ...
  },
  {
    ...
    body: 'We planned to open this post with a tester quote. We asked; nobody had replied by publish time — and we would rather show you the real funnel than wait for a compliment. So here are the numbers with the asterisk most companies skip: as of writing, 28 workspaces have signed up — and when you strip out our own team, our QA automation, and our verification accounts, exactly 2 are real people from outside, both of whom found us through Reddit with $0 spent on distribution of any kind. Of those 2, neither has run a first task yet. That signup-to-activation gap is the number we are chasing this month — and chasing it already caught us counting our own test accounts as external signups, a bug we fixed in public rather than quietly. The other caveats stand: small numbers, 14-day cardless trials, and a signup is not a customer until the card clears. When a tester puts their name to a quote, you will read it here unedited — including the parts that sting. Watch the funnel yourself: /signup?utm_source=site&utm_medium=bip&utm_campaign=phase3',
  },
  {
    date: '2026-09-14',
